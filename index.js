...
const instagramlu = 'https://instagram.com/febri_auliarahman';
const whatsapplu = '0822-6055-9781'; 
const kapanbotaktif = '24 Jam'; 
const grupch1 = 'https://chat.whatsapp.com/JIkiIw6TKrT2pRDhQXrUkC';  
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @febri_auliarahman`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @febri_auliarahman`)
})
